...
# Card descriptions
monopoly-card-advance-to-go = Vá para o INÍCIO e receba 200
...
monopoly-card-bank-dividend-50 = O banco paga a você um dividendo de 50
monopoly-card-go-back-three = Volte 3 casas
monopoly-card-go-to-jail = Vá diretamente para a prisão
monopoly-card-general-repairs = Faça reparos gerais em todas as suas propriedades: 25 por casa, 100 por hotel
monopoly-card-poor-tax-15 = Pague imposto de 15
...
monopoly-card-chairman-of-the-board = Presidente do conselho, pague 50 a cada jogador
monopoly-card-building-loan-matures = Seu empréstimo de construção venceu, receba 150
monopoly-card-crossword-competition = Você venceu um concurso de palavras cruzadas, receba 100
monopoly-card-bank-error-200 = Erro do banco a seu favor, receba 200
monopoly-card-doctor-fee-50 = Honorários médicos, pague 50
monopoly-card-sale-of-stock-50 = Pela venda de ações você recebe 50
monopoly-card-holiday-fund = Fundo de férias venceu, receba 100
monopoly-card-tax-refund-20 = Restituição de imposto de renda, receba 20
monopoly-card-birthday = É seu aniversário, receba 10 de cada jogador
monopoly-card-life-insurance = Seguro de vida venceu, receba 100
monopoly-card-hospital-fees-100 = Pague despesas hospitalares de 100
monopoly-card-school-fees-50 = Pague taxas escolares de 50
monopoly-card-consultancy-fee-25 = Receba 25 de honorários de consultoria
monopoly-card-street-repairs = Você foi cobrado por reparos de rua: 40 por casa, 115 por hotel
monopoly-card-beauty-contest-10 = Você ganhou o segundo prêmio em um concurso de beleza, receba 10
monopoly-card-inherit-100 = Você herda 100
