...
# Turn events
monopoly-pass-go = { $player } đi qua GO và nhận { $amount }.
...
monopoly-property-bought = { $player } đã mua { $property } với giá { $price }.
monopoly-rent-paid = { $player } đã trả { $amount } tiền thuê cho { $owner } vì { $property }.
monopoly-player-paid-player = { $player } đã trả { $amount } cho { $target }.
monopoly-you-completed-color-set = Bạn hiện sở hữu toàn bộ các bất động sản { $group }.
monopoly-player-completed-color-set = { $player } hiện sở hữu toàn bộ các bất động sản { $group }.
monopoly-you-completed-railroads = Bạn hiện sở hữu toàn bộ các đường sắt.
monopoly-player-completed-railroads = { $player } hiện sở hữu toàn bộ các đường sắt.
monopoly-you-completed-utilities = Bạn hiện sở hữu toàn bộ các tiện ích.
monopoly-player-completed-utilities = { $player } hiện sở hữu toàn bộ các tiện ích.
monopoly-landed-owned = { $player } đáp xuống chính bất động sản của mình: { $property }.
monopoly-tax-paid = { $player } đã trả { $amount } cho { $tax }.
...
monopoly-bail-paid = { $player } đã trả { $amount } tiền bảo lãnh.
...
monopoly-jail-card-used = { $player } đã dùng thẻ ra tù.
monopoly-sore-loser-rebate = { $player } nhận khoản hoàn lại cho người thua cay cú là { $amount }.
monopoly-cheaters-early-end-turn-blocked = { $player } cố kết thúc lượt quá sớm và bị phạt gian lận { $amount }.
monopoly-cheaters-payment-avoidance-blocked = { $player } bị phạt vì né thanh toán số tiền { $amount }.
monopoly-cheaters-reward-granted = { $player } nhận thưởng gian lận { $amount }.
...
monopoly-auction-won = { $player } thắng cuộc đấu giá { $property } với giá { $amount }.
monopoly-property-mortgaged = { $player } đã thế chấp { $property } với giá { $amount }.
monopoly-property-unmortgaged = { $player } đã chuộc thế chấp { $property } với giá { $amount }.
monopoly-house-built-house = { $player } đã xây một ngôi nhà trên { $property } với giá { $amount }. Giờ ô này có { $level }.
monopoly-house-built-hotel = { $player } đã xây một khách sạn trên { $property } với giá { $amount }.
monopoly-house-sold = { $player } đã bán một công trình trên { $property } với giá { $amount } (cấp: { $level }).
...
monopoly-free-parking-jackpot = { $player } nhận jackpot Bãi đỗ xe miễn phí là { $amount }.
...
monopoly-mortgage-transfer-interest-paid = { $player } đã trả { $amount } tiền lãi khi nhận bất động sản thế chấp.

# Card engine
monopoly-card-drawn = { $player } rút một thẻ { $deck }: { $card }.
monopoly-card-collect = { $player } nhận được { $amount }.
monopoly-card-pay = { $player } đã trả { $amount }.
monopoly-card-move = { $player } được chuyển đến { $space }.
monopoly-card-jail-free = { $player } nhận một thẻ ra tù.
...
# Card descriptions
monopoly-card-advance-to-go = Đi đến GO và nhận { $amount }
...
monopoly-card-bank-dividend-50 = Ngân hàng trả cho bạn cổ tức { $amount }
monopoly-card-go-back-three = Lùi 3 ô
monopoly-card-go-to-jail = Đi thẳng vào tù
monopoly-card-general-repairs = Sửa chữa toàn bộ tài sản của bạn: { $per_house } cho mỗi nhà, { $per_hotel } cho mỗi khách sạn
monopoly-card-poor-tax-15 = Trả thuế { $amount }
monopoly-card-reading-railroad = Đi đến Reading Railroad
monopoly-card-boardwalk = Đi dạo đến Boardwalk
monopoly-card-chairman-of-the-board = Chủ tịch hội đồng, trả cho mỗi người chơi { $amount }
monopoly-card-building-loan-matures = Khoản vay xây dựng của bạn đến hạn, nhận { $amount }
monopoly-card-crossword-competition = Bạn thắng cuộc thi ô chữ, nhận { $amount }
monopoly-card-bank-error-200 = Lỗi ngân hàng có lợi cho bạn, nhận { $amount }
monopoly-card-doctor-fee-50 = Phí bác sĩ, trả { $amount }
monopoly-card-sale-of-stock-50 = Bán cổ phiếu, bạn nhận { $amount }
monopoly-card-holiday-fund = Quỹ nghỉ lễ đến hạn, nhận { $amount }
monopoly-card-tax-refund-20 = Hoàn thuế thu nhập, nhận { $amount }
monopoly-card-birthday = Hôm nay là sinh nhật bạn, nhận { $amount } từ mỗi người chơi
monopoly-card-life-insurance = Bảo hiểm nhân thọ đến hạn, nhận { $amount }
monopoly-card-hospital-fees-100 = Trả phí bệnh viện { $amount }
monopoly-card-school-fees-50 = Trả học phí { $amount }
monopoly-card-consultancy-fee-25 = Nhận phí tư vấn { $amount }
monopoly-card-street-repairs = Bạn bị tính phí sửa đường: { $per_house } cho mỗi nhà, { $per_hotel } cho mỗi khách sạn
monopoly-card-beauty-contest-10 = Bạn đoạt giải nhì cuộc thi sắc đẹp, nhận { $amount }
monopoly-card-inherit-100 = Bạn được thừa kế { $amount }
